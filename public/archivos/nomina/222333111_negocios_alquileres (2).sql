...
-- Tiempo de generación: 30-01-2024 a las 03:18:08
...
(2, 2, '1', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 'secreta', 2);
...
('111222333', 'eduadmin', 'eduadmin', 'eduadmin@eduadmin', 'admin'),
('112233445', 'samuadmin', 'samuadmin', 'samuadmin@samuadmin', 'samuadmin'),
('121212121', 'hajaradmin', 'hajaradmin', 'hajaradmin@hajaradmin', 'admin'),
('123456789', 'samu', 'samu', 'samu@samu', 'samu'),
('222333111', 'eduardo', 'lizana', 'edu@edu', 'edu'),
('987654321', 'hajar', 'hajar', 'hajar@hajar', 'hajar');
...
--
ALTER TABLE `CHATEAR`
  MODIFY `Id_mensaje` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `NOTIFICACION`
  MODIFY `id_notificacion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `OFERTA`
--
ALTER TABLE `OFERTA`
  MODIFY `id_oferta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `VAL_INMUEBLE`
  MODIFY `id_valoracion_inmueble` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
