                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <div class="col-12">
                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                            ...
                            <div class="offcanvas-body d-flex flex-wrap flex-lg-row p-4 lg-0">
                                 <!-- Logo -->
                                <a class="navbar-brand fs-4 font-weight-bold pt-4 tetx-white col-2" href="<?php echo RUTA_URL ?>/">
                                ...
                                <ul class="navbar-nav justify-content-center flex-grow-1 col-3 pe-3">
                                    <ul class="navbar-nav">
                                ...
                                <!-- Action buttons -->
                                <a href="/OfertasControlador/addoferta" class="text-white text-decoration-none px-3 py-1 col-1 rounded-4 m-2" style="background-color: #568C98;">Publicar Ofertas +</a>
                                <a href="/NegocioControlador/addnegocio" class="text-white text-decoration-none px-3 py-1 col-1 rounded-4 m-2" style="background-color: #568C98;">Publicar Negocio +</a>

                                <!-- User actions -->
                                <div class="d-flex flex-column flex-lg-row justify-content-end align-items-center col-3 gap-3">
                                    <div class="dropdown">
...
<div class="container-fluid row min-vh-100 mt-5 mb-5">