...
?>
 ...
 <!-- Navegación de píldoras para los pasos del formulario -->
  <ul class="nav nav-pills mb-4" id="pills-tab">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#paso3" data-toggle="pill" onclick="mostrarPaso('#paso3')">Paso 3</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#paso4" data-toggle="pill" onclick="mostrarPaso('#paso4')">Paso 4</a>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="paso3">
                <h1 class="mb-4">Paso 3: Datos personales</h1>
                <form method="post">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="ubicacion" class="form-control" placeholder="Email">
                    </div>
                </form>
            </div>
